export const experience = [
  { company: "PayPay India", role: "Software Development Engineer II", period: "Jul 2026 — Present", place: "Gurugram, India", href: "https://paypay.co.in/", summary: "Building scalable, high-performance frontend architecture for consumer gift vouchers and fintech products." },
  { company: "Tellius", role: "Software Development Engineer II", period: "Jun 2025 — Jul 2026", place: "Bengaluru, India · Hybrid", href: "https://tellius.com/", summary: "Built agentic workflow interfaces, real-time analytics, and a streaming UI layer for AI-powered data modelling.", outcomes: ["Handled five concurrent AI stream types with sub-200ms perceived response latency.", "Removed an intermediate chart format so LLM output could render directly in React.", "Integrated real-time speech-to-text capabilities for voice-driven product interactions.", "Kept enterprise dashboards responsive at 60fps with virtualization and incremental rendering.", "Architected multi-provider SAML 2.0 SSO, reducing authentication support tickets by 30%."] },
  { company: "Bajaj Finserv Health", role: "Software Development Engineer", period: "Aug 2022 — Jun 2025", place: "Pune, India", href: "https://www.bajajfinservhealth.in/", summary: "Progressed from Intern to full-time SDE, building patient journeys, platform performance, SEO, and shared frontend foundations.", outcomes: ["Improved load times by 70% through Next.js ISR and a more thoughtful delivery strategy.", "Increased appointments by 40% by leading the end-to-end OPD booking experience.", "Scaled organic traffic beyond 100K users/month with Core Web Vitals and structured-data improvements.", "Helped evolve a monolith into a microfrontend architecture for greater team autonomy.", "Led the Medicard flow, reduced re-renders with React Profiler/custom hooks, and improved API visibility with ELK dashboards."] },
